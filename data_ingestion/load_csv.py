...
Purpose:
    ...
    - Enforce multi-year dtype consistency
...
def load_sr_csv(filepath: str, encodings=("utf-8", "latin1", "cp1252")) -> pd.DataFrame:
    """
    Load a Schedule R CSV file and return a DataFrame with all columns preserved.
...
def load_5500_csv(
    ...
    HEADER_MAP_5500 = {
        ...
        "SCH_R_EIN": "EIN",
        "EIN": "EIN",
        "PLAN_NUM": "PLAN_NUMBER",
        "PLAN_NUMBER": "PLAN_NUMBER",
        "SB_PN": "PLAN_NUMBER",
        "SCH_R_PLAN_NUM": "PLAN_NUMBER",
        "PLAN_YR": "PLAN_YEAR",
        "PLAN_YEAR": "PLAN_YEAR",
        "SB_PLAN_YR": "PLAN_YEAR",
        "SCH_R_PLAN_YR": "PLAN_YEAR",
        "ACK_ID": "ACK_ID",
        "SCH_R_ACK_ID": "ACK_ID",
        "ACT_PARTCP_CNT": "ACTIVE_COUNT",
        "ACTIVE_COUNT": "ACTIVE_COUNT",
        "RTD_PARTCP_CNT": "RETIREE_COUNT",
        "RETIREE_COUNT": "RETIREE_COUNT",
        "TERM_PARTCP_CNT": "TERMINATED_COUNT",
        "TERMINATED_COUNT": "TERMINATED_COUNT",
        "TOT_PARTCP_CNT": "TOTAL_PARTICIPANTS",
    ...
    # Multi-year dtype enforcement
    int_fields = [c for c in df.columns if "PARTICIPANT" in c or "COUNT" in c]
    float_fields = [
        c
        for c in df.columns
        if "LIABILITY" in c
        or (schedule_r and "ASSET_" in c)
        or c in ["ANNUITY_PURCHASES", "TRANSFERRED_TO_INSURERS", "BENEFITS_PAID", "CONTRIBUTIONS"]
    ]
    ...
    # Schedule R asset fields
    if schedule_r:
        r_cols = [
            "ASSET_ALTERNATIVES_PCT",
            "ASSET_CASH_PCT",
            "ANNUITY_PURCHASES",
            "TRANSFERRED_TO_INSURERS",
            "BENEFITS_PAID",
            "CONTRIBUTIONS",
        ]
        for col in r_cols:
